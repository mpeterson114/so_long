...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   route_checker_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mpeterso <mpeterso@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/25 11:46:01 by mpeterso          #+#    #+#             */
/*   Updated: 2023/05/25 12:28:18 by mpeterso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	get_player_pos(char **copy, t_game *game)
{
	while (game->player_y < game->mapheight
		&& copy[game->player_y][game->player_x] != 'P')
	{
		game->player_x = 1;
...
static void	c_route(char **copy, t_game *game, int x, int y)
{
	...
	if (copy[y - 1][x] == '0' || copy[y + 1][x] == '0'
		|| copy[y][x - 1] == '0' || copy[y][x + 1] == '0'
		|| copy[y - 1][x] == 'C' || copy[y + 1][x] == 'C'
		|| copy[y][x - 1] == 'C' || copy[y][x + 1] == 'C')
		copy[y][x] = 'Z';
